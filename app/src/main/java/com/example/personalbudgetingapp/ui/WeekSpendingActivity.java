...
public class WeekSpendingActivity extends AppCompatActivity {
    ...
    private void readMonthSpendingItems() {
        ...
        query.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                //calculate total amount of whole week
                int totalAmount = 0;
                for (DataSnapshot ds : snapshot.getChildren()) {
                    ...
                    totalWeekAmountTv.setText("Total Month's Spending: Rs. " + totalAmount);
                }
    ...
    /**
     * show all the items of the week
     */
        ...
        query.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                for (DataSnapshot ds : snapshot.getChildren()) {
                    ...
                    totalWeekAmountTv.setText("Total Week's Spending: Rs. " + totalAmount);
                }
