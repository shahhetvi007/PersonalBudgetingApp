        ...
        budgetRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                for (DataSnapshot dataSnapshot : snapshot.getChildren()){
                    ...
                    String sTotal = "Month budget: Rs " + totalAmount;
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if (snapshot.exists() && snapshot.getChildrenCount()>0){
                    ...
                    for (DataSnapshot snap : snapshot.getChildren()){
                        ...
                        totalAmount += data.getAmount();
                        String sTotal = "Month Budget: " + totalAmount;
                        totalBudgetAmountTv.setText(sTotal);
                    }
            ...
            public void onClick(View v) {
                ...
                if (budgetItem.equals("Select item")){
                    ...
                    Data data = new Data(budgetItem, date, id, itemNDay, itemNWeek, itemNMonth,
                            Integer.parseInt(budgetAmount), months.getMonths(), weeks.getWeeks(), null);
        ...
        btnUpdate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Data data = new Data(item, date, post_key, itemNDay, itemNWeek, itemNMonth,
                         amount, months.getMonths(), weeks.getWeeks(), null);
